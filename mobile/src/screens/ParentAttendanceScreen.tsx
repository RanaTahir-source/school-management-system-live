...
// Same UI as the student AttendanceScreen, but hits the parent-portal
// endpoint for a chosen child's studentId.
export default function ParentAttendanceScreen({ route }: Props) {
  ...
  const load = useCallback(async () => {
    setError(null);
    try {
      const data = await api.get<AttendanceRecord[]>(`/parent-portal/children/${studentId}/attendance`, { from, to });
